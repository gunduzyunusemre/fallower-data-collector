/**
  ...
  ******************************************************************************
  */
#ifndef AI_FALLOWER1_H
#define AI_FALLOWER1_H

#include "fallower1_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_FALLOWER1_MODEL_NAME          "fallower1"
#define AI_FALLOWER1_ORIGIN_MODEL_NAME   "mobilenetv3small_1ch_mti_norm_fallf1_90_macc_83"

/******************************************************************************/
#define AI_FALLOWER1_ACTIVATIONS_ALIGNMENT   (4)
#define AI_FALLOWER1_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FALLOWER1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FALLOWER1_IN_NUM        (1)

AI_DEPRECATED
#define AI_FALLOWER1_IN \
  ai_fallower1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FALLOWER1_IN_SIZE { \
  AI_FALLOWER1_IN_1_SIZE, \
}
#define AI_FALLOWER1_IN_SIZE_BYTES { \
  AI_FALLOWER1_IN_1_SIZE_BYTES, \
}
#define AI_FALLOWER1_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FALLOWER1_IN_1_HEIGHT      (30)
#define AI_FALLOWER1_IN_1_WIDTH       (688)
#define AI_FALLOWER1_IN_1_CHANNEL     (1)
#define AI_FALLOWER1_IN_1_SIZE        (20640)
#define AI_FALLOWER1_IN_1_SIZE_BYTES  (82560)

/******************************************************************************/
#define AI_FALLOWER1_OUT_NUM       (1)

AI_DEPRECATED
#define AI_FALLOWER1_OUT \
  ai_fallower1_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FALLOWER1_OUT_SIZE { \
  AI_FALLOWER1_OUT_1_SIZE, \
}
#define AI_FALLOWER1_OUT_SIZE_BYTES { \
  AI_FALLOWER1_OUT_1_SIZE_BYTES, \
}
#define AI_FALLOWER1_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FALLOWER1_OUT_1_CHANNEL     (7)
#define AI_FALLOWER1_OUT_1_SIZE        (7)
#define AI_FALLOWER1_OUT_1_SIZE_BYTES  (28)

/******************************************************************************/
#define AI_FALLOWER1_N_NODES (139)
 ...
 * @ref ai_fallower1_create. Both the activations memory buffer 
 ...
 * using @ref ai_fallower1_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_fallower1_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_fallower1_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FALLOWER1_*
 * defines into file @ref fallower1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_fallower1_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_FALLOWER1_H */
